...
for k = 1 : num_images
    image = double(imread(['images/landsat_1/landsat_' num2str(k) '.png']))/255;
    mask = double(imread(['images/landsat_1/mask_' num2str(k) '.png']))/255;
    ...
    imwrite(img, ['landsat_1_' num2str(k) '.png'], 'png');
    imwrite(1 - alpha, ['landsat_1_' num2str(k) '_mask.png'], 'png');
end
...
imwrite(fused, 'landsat_1_fused.png', 'png');
